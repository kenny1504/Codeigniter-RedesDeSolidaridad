                     ...
                     <thead>  <!--Header de la tabla -->  
                       <tr > 
                        ...
                        <?php foreach ($grados as $grado): ?><!--ciclo que recorre el arreglo retonrnado del controlador-->
                                ...
                                <td>
            <!-- Boton Nuevo--> <button class="btn btn-primary" onclick='mostrar_Materias_grados(this)' data-id1="<?php echo $grado['id']; ?>" data-Nombre="<?php echo $grado['Grado'];?>">ver</button>  <!--botton para ver ** Sirve para ver materias asignadas a este grado** -->     
