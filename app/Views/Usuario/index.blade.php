                     ...
                     <thead>  <!--Header de la tabla -->  
                       <tr > 
                        ...
                        <?php foreach ($usuarios as $usuario): ?><!--ciclo que recorre el arreglo retonrnado del controlador-->
                                ...
                                <td>
            <!-- Boton Nuevo--> <button class="btn btn-primary" onclick='' data-id="<?php echo $usuario['Id_Usuarios']; ?>" data-Nombre="<?php echo $usuario['Nombre'];?>" id="Ver-Asignaturas">ver</button>  <!--botton para ver ** Sirve para ver materias asignadas a este grado** -->     
