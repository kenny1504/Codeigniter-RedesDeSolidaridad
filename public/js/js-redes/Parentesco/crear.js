...
$("#parentesco").click(function() { //ajax para ingresar Oficio
  ...
  $.ajax({
    type: 'POST',
    url: 'parentesco/agregar', //llamada a la ruta ingresar Oficio
    data: $('#ingresar_parentesco').serialize(), // manda el form donde se encuentra la modal oficio
    ...
    success: function(data){ //agregar el nuevo ingreso a la tabla
      ...
      + "<button class='btn btn-info' data-id="+ data.id +" onclick='eliminar-parentesco(this);'><i class='fa fa-fw fa-trash '></i></button>"                                   
